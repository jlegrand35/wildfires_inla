...
```{r message=F}
#| label: tbl-slope
#| tbl-cap: "Estimated slopes $\\beta$ of the linear predictor defined in Eq. (5) for each climate model"
...
All data used in this study are available at the following link: <span style="color:red;">ajouter lien zenodo</span>. Note that for confidentiality reasons, the fire data provided correspond to simulated data from the model developed in this work.
