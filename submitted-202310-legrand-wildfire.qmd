...
![Locations of wildfire activities during 2006-2020 over the region of interest.](computo_figures/map_aquitaine.png){#fig-fire-plot width=90%}
...
There are `r nrow(DF)` observations in the wildfire dataset, but only `r sum(DF$NB0.1)` actual wildfires.
...
All data used in this study are available at the following link: [https://doi.org/10.5281/zenodo.7870592](https://doi.org/10.5281/zenodo.7870592). Note that for confidentiality reasons, the wildfire data provided correspond to simulated data from the model developed in this work.
